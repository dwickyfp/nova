...
import { agentAccessApi, rolesApi, type AccessCheckResult } from '@/features/agents/api'
...
export function AgentAccessTab({ agentId }: { agentId: string }) {
  ...
  const addRole = useMutation({
    ...
    onSuccess: () => {
      ...
      setRoleName('')
      setGrantType('USAGE')
      queryClient.invalidateQueries({ queryKey: ['agents', 'access', agentId] })
    },
      ...
      <div className='flex items-center justify-between gap-3'>
        ...
        <div className='flex items-center gap-2'>
          <Button
            ...
            onClick={() => roles[0] && onVerify(roles[0].role_name)}
          >
          ...
          <div className='mx-auto flex max-w-4xl items-start justify-between gap-4'>
            <div className='min-w-0'>
              <div className='mb-2 flex items-center gap-2'>
                ...
                <Badge variant={result.all_granted ? 'secondary' : 'destructive'}>
            ...
            <div className='space-y-2'>
              ...
              <Select value={roleName || undefined} onValueChange={setRoleName}>
                <SelectTrigger>
                  <SelectValue
                    placeholder={
                      availableRolesQuery.isLoading ? 'Loading roles…' : 'Select a role'
                    }
                  />
                </SelectTrigger>
                <SelectContent>
