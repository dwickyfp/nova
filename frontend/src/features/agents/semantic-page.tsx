...
import { Database, FileCode2, Trash2, Wand2 } from 'lucide-react'
      ...
      <Main>
        <div className='mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between'>
          <div className='min-w-0'>
            <h1 className='text-2xl font-semibold tracking-tight'>Semantic models</h1>
              ...
              <div className='rounded-md border p-3 text-sm'>
                {validation.valid ? (
                  <p className='text-success'>
                    Valid Ossie {validation.ossie_version}: {validation.dataset_count}{' '}
                    datasets, {validation.metric_count} metrics,{' '}
