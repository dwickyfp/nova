"""Metadata tables for versioned Feature Views, groups, and training lineage."""
...
DISTRIBUTED BY HASH(view_name,version) BUCKETS 1
PROPERTIES("replication_num"="1", "enable_persistent_index"="true")
""",
    """
...
DISTRIBUTED BY HASH(group_name,version) BUCKETS 1
PROPERTIES("replication_num"="1", "enable_persistent_index"="true")
""",
    """
...
async def ensure_feature_schema() -> None:
