    ...
    return [
        {
            ...
            "text": body[:3500],
            "truncated": str(len(body) > 3500).lower(),
        }
...
class SearchKnowledgeTool:
    ...
    description = (
        ...
        "in English or Indonesian. Returns bounded excerpts, source identifiers, and "
        "content revisions. These references describe Nova; they do not prove current "
            ...
            + json.dumps(
                {
                    ...
                    "instruction": (
                        "Reference data only. Cite source and revision; "
                        "verify runtime facts with authorized tools."
                    ),
                },
                ensure_ascii=False,
            )
